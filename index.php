                ...
                <form method="POST" id="formulario" action="processa_dados.php">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12 ">
                                    ...
                                    <input type="text" class="form-control shadow-none" name="nome" id="nome" required data-input />
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="col-sm-12">
                                    <label class="control-label">Email</label>
                                    <input type="text" class="form-control shadow-none" name="email" id="email" required data-input />
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" name="cpf" id="cpf" required data-input />
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" id="celular" name="celular" required data-input />
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" id="rg" name="rg" required data-input />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" class="form-control shadow-none" id="orgaoEmissor" name="orgaoEmissor" maxlength="6" required data-input />
                                </div>
                                <div class="col-sm-3">
                    ...
                    <div class="EstH3">
                        <fieldset>
                            ...
                            <div class="teste">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="listbox2">
                                        <br><br>
                                        <div class="dropdown bootstrap-select show-tick form-control">
                                            <select id="listBox2" class="selectpicker form-select shadow-none " name="ocupacaoSecundaria[]" size="10">
                            ...
                            <div class="form-group ">
                                <div class="col-sm-8">
                                    <label class="control-label">Nome Fantasia no CNPJ MEI</label>
                                    <input type="text" class="form-control shadow-none" name="nomeFantasia" value="" id="nome-fantasia" />
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group ">
                                <div class="col-sm-12 ">
                                    <label class="col-sm-12 control-label">Forma de Atuação</label>
